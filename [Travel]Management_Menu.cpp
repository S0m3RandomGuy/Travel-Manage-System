...
public:
    ...
    void cabDetails()
    {
        ...
        if (cabChoice == 1) {
            ...
            cout << "\nYour tour will cost " << cabCost << " dollar for a standard cab" << endl;
            ...
            cout << "\nYour tour will cost " << cabCost << " dollar for a luxury cab" << endl;
            cout << "Press 1 to hire this cab: or ";
            cout << "Press 2 to select another cab: ";
            cin >> hireCab;
            system("CLS");
...
public:
    ...
    void hotels()
    {
        ...
        if (choiceHotel == 1) {
            ...
            cout << "\tAll basic facilities you need just for: $5000.00" << endl;
            cout << "2. Premium Pack" << endl;
            cout << "\tEnjoy Premium: $10000.00" << endl;
            cout << "3. Luxury Pack" << endl;
            cout << "\tLive a Luxury at Avendra: $15000.00" << endl;
            ...
            cout << "\t $15000.00 for a day" << endl;
            cout << "2. Couple Pack" << endl;
            cout << "\t $10000.00 for a day" << endl;
            ...
            cout << "Amazing offer in this summer: $5000.00 for a one day!!!" << endl;
